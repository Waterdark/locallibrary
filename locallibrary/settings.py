...
SECRET_KEY = 'n$6elm+tblkp-m4e7_-7-960_*g-&)zv_swikkohd+k7b8v30*'
...
INSTALLED_APPS = [
    ...
    #ссылается на папку catalog/файл apps.py/в самом файле class CatalogConfig
...
# Перенаправление на домашний URL после входа в систему (по умолчанию /accounts/profile/)
LOGIN_REDIRECT_URL = '/'
